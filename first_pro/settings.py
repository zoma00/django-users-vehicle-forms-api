...
AUTHENTICATION_BACKENDS = [
    ...
    'accounts.backends.CustomUserBackend',  # Replace with actual path
]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # Update for Postgres
        'URL': os.environ.get('DATABASE_URL'),  # Use Heroku Postgres URL
    }
}
"""
...
# Assuming your API credentials are stored in environment variables
